...
const toggleServerInfo = () => {
	console.log('toggle server info');
	const serverLogContainer = document.querySelector('#server-log-panel');
	serverLogContainer.classList.toggle('slds-is-open');
	serverLogContainer.classList.toggle('slds-is-closed');
}
const toggleDebugInfo = () => {
	console.log('toggle debug info');
	const debugLogContainer = document.querySelector('#debug-log-panel');
	debugLogContainer.classList.toggle('slds-is-open');
	debugLogContainer.classList.toggle('slds-is-closed');
}
const toggleErrorInfo = () => {
	console.log('toggle error info');
	const errorLogContainer = document.querySelector('#error-log-panel');
	errorLogContainer.classList.toggle('slds-is-open');
	errorLogContainer.classList.toggle('slds-is-closed');
}